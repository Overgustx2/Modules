...
if game.CoreGui:FindFirstChild('UIBUTTON') then game.CoreGui:FindFirstChild('UIBUTTON'):Destroy()end
local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService")
...
Frame.Position = UDim2.new(0.15, 0, 0.16, 0)
...
ImageButton.Image = "rbxassetid://106326553644631"
ImageButton.Draggable = true
UIStroke.Parent = ImageButton
UIStroke.Thickness = 3
UIStroke.Color = Color3.fromRGB(118,222,243)
